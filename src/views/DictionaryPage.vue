...
.dict-char.not-found{font-family:'KaiTi','STKaiti',serif;font-size:16px;color:var(--ink-wash);line-height:2.5;display:flex;align-items:center;justify-content:center;min-height:72px}
