...
const chars = [
  { char: '\u65E5', meaning: '日 / 太阳', category: '象形字', era: '殷商', desc: '外圆象太阳之形，中一点象光。卜辞中用作白天、日期，亦作祭名。殷人记日以干支，十日为一旬。' },
  { char: '\u6708', meaning: '月 / 月亮', category: '象形字', era: '殷商', desc: '象半月之形，缺而不满。卜辞中记月份、夜晚皆用此字。殷历以月相变化定朔望。' },
  { char: '\u4EBA', meaning: '人', category: '象形字', era: '殷商', desc: '象人侧立垂臂之形，肢体完备而简洁。卜辞中大量出现，是最基础的象形字，也是众多汉字的构件。' },
  { char: '\u5927', meaning: '大', category: '象形字', era: '殷商', desc: '象人正面站立、张开双臂之形，以大人之形表"大"义。引申为规模大、程度深。"太""天"皆从此出。' },
  { char: '\u5929', meaning: '天 / 天空', category: '会意字', era: '殷商', desc: '从"大"从"一"，一人头顶之上即为天。卜辞中亦指上天、天帝，是殷人祭祀的重要对象。' },
  { char: '\u96E8', meaning: '雨', category: '象形字', era: '殷商', desc: '上象云层，下象雨滴下落之形。商代以农为本，卜辞中频繁出现"其雨""不雨""大雨""小雨"等。' },
  { char: '\u5C71', meaning: '山', category: '象形字', era: '殷商', desc: '三峰并立，中高旁低，象山脉连绵起伏之形。卜辞中多用作地名及山神祭祀。' },
  { char: '\u6C34', meaning: '水', category: '象形字', era: '殷商', desc: '中间曲线象主流水流，两旁散点象水花飞溅。卜辞中用作河流名称及水患记录。' },
  { char: '\u706B', meaning: '火', category: '象形字', era: '殷商', desc: '象火焰上腾之形，下宽上尖。卜辞中用作火灾、火星（大火星）等义。' },
  { char: '\u6728', meaning: '木 / 树', category: '象形字', era: '殷商', desc: '上象枝桠，中象树干，下象根须，一株完整的树。卜辞中用作树木、木材及木星（岁星）。' },
  { char: '\u738B', meaning: '王 / 首领', category: '象形字', era: '殷商', desc: '象斧钺之形，斧钺是王权的象征。卜辞中称商王为"王"，是最常见的称谓之一。' },
  { char: '\u5B50', meaning: '子', category: '象形字', era: '殷商', desc: '象婴儿之形，大头、双臂、身体包裹。卜辞中用作子女义，亦为地支之首（子丑寅卯）。' },
  { char: '\u9F8D', meaning: '龙', category: '象形字', era: '殷商', desc: '象龙之形，有角冠、巨口、长身卷尾。传说中能兴云雨的神兽，殷人信仰中的重要神灵。' },
  { char: '\u98A8', meaning: '风', category: '形声字', era: '殷商', desc: '从虫凡声。卜辞中四方风各有专名，殷人对季风已有系统认识。' },
  { char: '\u4E0A', meaning: '上', category: '指事字', era: '殷商', desc: '以一长横为基准，上方短横指示"上"的位置。与"下"相对，是中国最古老的指事字之一。' },
  { char: '\u4E0B', meaning: '下', category: '指事字', era: '殷商', desc: '以一长横为基准，下方短横指示"下"的位置。简洁而明确的构字方式。' },
  { char: '\u571F', meaning: '土 / 土地', category: '象形字', era: '殷商', desc: '象地上土块之形，一横为地面。卜辞中用作土地、社神等，是先民生息的根本。' },
  { char: '\u5973', meaning: '女', category: '象形字', era: '殷商', desc: '象女子跪坐交手之形。卜辞中用作女性、配偶等义，是重要的性别标识字。' },
  { char: '\u4E2D', meaning: '中 / 中央', category: '指事字', era: '殷商', desc: '一竖贯穿圆圈中部，表示正中。卜辞中用作中间、中等义，亦为族名和地名。' },
  { char: '\u98DF', meaning: '食 / 食物', category: '会意字', era: '殷商', desc: '上为口，下为盛食物的器皿。卜辞中用作食物、食用、日食月食等义。' },
  { char: '\u5FC3', meaning: '心', category: '象形字', era: '殷商', desc: '象心脏之形，内分左右心房。古人认为心主思维，故凡从心之字多与思想感情有关。' },
  { char: '\u9B5A', meaning: '鱼', category: '象形字', era: '殷商', desc: '象鱼之形，有头、身、鳞、尾。卜辞中用作渔猎及祭祀供品。' },
  { char: '\u9CE5', meaning: '鸟', category: '象形字', era: '殷商', desc: '象鸟之形，有喙、头、身、翅、尾、爪。卜辞中用为鸟名及图腾。' },
  { char: '\u864E', meaning: '虎', category: '象形字', era: '殷商', desc: '象虎侧视之形，大口、利齿、斑纹、长尾。卜辞中用为方国名及狩猎对象。' },
  { char: '\u9E7F', meaning: '鹿', category: '象形字', era: '殷商', desc: '象鹿侧视之形，有角、头、身、足。卜辞中记猎鹿甚多，是殷人重要的狩猎对象。' },
  { char: '\u725B', meaning: '牛', category: '象形字', era: '殷商', desc: '象牛首正面之形，双角向上弯曲。卜辞中用作祭祀牺牲和财产。' },
  { char: '\u7F8A', meaning: '羊', category: '象形字', era: '殷商', desc: '象羊首正面之形，角向下弯曲。古以羊为祥，是重要的祭品和食物来源。' },
  { char: '\u9A6C', meaning: '马', category: '象形字', era: '殷商', desc: '象马侧视之形，突出长脸、鬃毛、四蹄。卜辞中用作车马和田猎。' },
  { char: '\u732A', meaning: '豕 / 猪', category: '象形字', era: '殷商', desc: '象猪侧视之形，突出长嘴和肥腹。是最早驯化的家畜之一。' },
  { char: '\u72AC', meaning: '犬 / 狗', category: '象形字', era: '殷商', desc: '象犬侧视张口之形。卜辞中用为狩猎助手及牺牲。' },
  { char: '\u7530', meaning: '田 / 田地', category: '象形字', era: '殷商', desc: '象纵横交错的田界。卜辞中用作农田和田猎，反映殷代农猎并重的经济。' },
  { char: '\u79BE', meaning: '禾 / 谷物', category: '象形字', era: '殷商', desc: '上象谷穗下垂，下象根茎。卜辞中记作物生长和收成，是农业社会的基本文字。' },
  { char: '\u9EC3', meaning: '黄 / 黄色', category: '象形字', era: '殷商', desc: '一说象佩玉璜之形。卜辞中用作颜色词和地名。' },
  { char: '\u767D', meaning: '白 / 白色', category: '象形字', era: '殷商', desc: '一说象米粒之形。卜辞中用作颜色和地名。"白"亦是"伯"的初文。' },
  { char: '\u8D64', meaning: '赤 / 红色', category: '会意字', era: '殷商', desc: '从大从火，大火之色为赤。殷人尚白少赤，但此字已见诸卜辞。' },
  { char: '\u8840', meaning: '血', category: '指事字', era: '殷商', desc: '器皿中有一圆点表示血液。用于祭祀中的血祭之礼。' },
  { char: '\u81E3', meaning: '臣', category: '象形字', era: '殷商', desc: '象竖目之形，屈身俯首之状。卜辞中用作臣僚，是商王的下属官吏。' },
  { char: '\u76EE', meaning: '目 / 眼睛', category: '象形字', era: '殷商', desc: '象人眼之形，外框为眼眶，内为瞳仁。卜辞中用作观察、监视义。' },
  { char: '\u8033', meaning: '耳 / 耳朵', category: '象形字', era: '殷商', desc: '象耳朵轮廓之形。卜辞中用为听、闻义，亦是人体的基本构件字。' },
  { char: '\u53E3', meaning: '口 / 嘴巴', category: '象形字', era: '殷商', desc: '象人口张开之形。凡与言语、饮食相关之字多从口。' },
  { char: '\u624B', meaning: '手', category: '象形字', era: '殷商', desc: '象手掌五指之形。凡与动作相关的字多从手，是汉字的重要部首。' },
  { char: '\u6B62', meaning: '止 / 足趾', category: '象形字', era: '殷商', desc: '象脚掌和脚趾之形。凡与行走相关的字多从止，如步、此、正等。' },
  { char: '\u884C', meaning: '行 / 行走', category: '象形字', era: '殷商', desc: '象十字路口之形，本义为道路，引申为行走。卜辞中亦用为"行走"义。' },
  { char: '\u6765', meaning: '来 / 到来', category: '象形字', era: '殷商', desc: '本象麦穗之形，借为"往来"之"来"。卜辞中大量用作动词。' },
  { char: '\u51FA', meaning: '出 / 出去', category: '会意字', era: '殷商', desc: '从止从凵，脚从坑中跨出。与"各"（进入）相对，是最基本的运动动词。' },
  { char: '\u5165', meaning: '入 / 进入', category: '指事字', era: '殷商', desc: '象尖锐物进入之形，与"人"字区分明显。卜辞中用作进入、收入义。' },
  { char: '\u4E00', meaning: '一', category: '指事字', era: '殷商', desc: '以一道横画表示数目一。是最简单的指事字，也是数字体系的基础。' },
  { char: '\u4E09', meaning: '三', category: '指事字', era: '殷商', desc: '以三道横画表示数目三。"三"又常表示多数，如"三思""再三"。' },
  { char: '\u4E94', meaning: '五', category: '指事字', era: '殷商', desc: '甲骨文"五"作X形交叉，至西周中后期方定型为今日写法。' },
  { char: '\u5341', meaning: '十', category: '指事字', era: '殷商', desc: '以一竖画表示数目十。殷人以十进制计数，卜辞中大量使用。' },
]
...
.detail-card{background:#fff;border-radius:var(--radius-lg);padding:40px 36px 32px;text-align:center;max-width:440px;width:100%;position:relative;box-shadow:0 20px 60px rgba(0,0,0,.2);animation:modalIn .3s ease}
